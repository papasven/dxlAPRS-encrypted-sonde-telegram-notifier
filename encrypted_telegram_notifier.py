...
# Send information to wettersonde.net set this to True or False
send_ws = True
    ...
    while True:
        try:
            ...
            if os.path.exists(file_path):
                ...
                # Send information to wettersonde.net
                if send_ws:
                    r = requests.get('http://api.wettersonde.net/encrypt.php?', params = {"serial": serial,"frequency": frequency,"callsign": callsign})
                    if r.status_code== 200:
                        print(f"Succesfully sent to wettersonde.net.")
                    else:
                        print(f"Unsuccessfully sent to wettersonde.net.")
